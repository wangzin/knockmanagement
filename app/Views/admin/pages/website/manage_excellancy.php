<section class="content-header">
  	<h1>
	    Home
	    <small>Website Settings >> Manage Excellence </small>
  	</h1>
</section>
	        		...
	        		<table id="data_table" class="table table-bordered table-striped" width="100%">
			            ...
			            <tbody>
		            	 	<?php if($data!=null && sizeof($data)>0){ 
								...
								<tr>
									<td> 
										<img onerror="this.src='https://www.merchantsmarket.com/wp-content/uploads/2018/01/menu.png'" src="<?php echo base_url();?>images/excellancy/<?=$dat['image'];?>" width="150" id="page_image1" class="img-text" align="left"> 
									</td>
...
<div class="modal modal-default" id="adddesignationid">
  	<div class="modal-dialog modal-lg">
    	<div class="modal-content">
            <form class="bootbox-form form-horizontal" enctype="multipart/form-data" method="POST" action="/529288ce6f5efcd3a2f57dea8f48fb4131f90c3e/9b4782210240dabe1ec496b29958f0b4" id="excellancyform">
 	...
 	function showedit(id){
        ...
        $.ajax({
			...
			'success': function(data){  
                ...
                let current_image='<br><img  src="<?php echo base_url();?>images/excellancy/'+data.image+'" width="150" class="img-text"> ';
