<section class="content-header">
  	<h1>
	    Home
	    <small>Website Settings >> Manage Event Calander </small>
  	</h1>
</section>
...
<div class="modal modal-default" id="adddesignationid">
  	<div class="modal-dialog modal-lg">
    	<div class="modal-content">
            <form class="bootbox-form form-horizontal" enctype="multipart/form-data" method="POST" action="/529288ce6f5efcd3a2f57dea8f48fb4131f90c3e/e1ac91da0b1acd8ebb5a4c2c0c18f2c4" id="servicesform">
				...
				<div class="modal-body">
  				 	<div class="form-group">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							...
							<input type="text" name="date_time" id="date_time" class="form-control" onchange="remove_error('date_time')">
							<span class="text-danger" id="date_time_err"></span>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
...
<div class="modal modal-default" id="deleterecordid" >
  	<div class="modal-dialog modal-lg">
    	<div class="modal-content">
        <form class="bootbox-form form-horizontal" method="POST" action="/529288ce6f5efcd3a2f57dea8f48fb4131f90c3e/5fb6fd5d21e8c9bb6b1bb3fbf2d1f79c" id="deleteserviceform">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript">
	...
	function clear_form(){
 	...
 	function showedit(id){
		let url='/529288ce6f5efcd3a2f57dea8f48fb4131f90c3e/105c6208c616cea2fae8296fccd0c039/'+id;
        $.ajax({
			'url': url,
			'type': 'GET',
			'dataType': 'json',
	...
	function validatedform(){
		let ret_type=true;
		if($('#date_time').val()==""){
		$('#date_time_err').html("Please mention date and time");
			ret_type=false;
		}
		if($('#name').val()==""){
