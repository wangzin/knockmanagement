<section class="content-header">
  	<h1>
	    Home
	    <small>Website Settings >> Manage Cleaning Process </small>
  	</h1>
</section>
	        		...
	        		<table id="data_table" class="table table-bordered table-striped" width="100%">
			            ...
			            <tbody>
		            	 	<?php if($data!=null && sizeof($data)>0){ 
								...
								<tr>
									<td> 
										<img onerror="this.src='https://www.merchantsmarket.com/wp-content/uploads/2018/01/menu.png'" src="<?php echo base_url();?>images/cleaningprocess/<?=$dat['image'];?>" width="150" id="page_image1" class="img-text" align="left"> 
									</td>
...
<div class="modal modal-default" id="adddesignationid">
  	<div class="modal-dialog modal-lg">
    	<div class="modal-content">
            <form class="bootbox-form form-horizontal" enctype="multipart/form-data" method="POST" action="/529288ce6f5efcd3a2f57dea8f48fb4131f90c3e/9b4783310240dabe1ec496b29958f0b4" id="excellancyform">
				...
				<div class="modal-footer">
					<div class="row pull-right">
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
							...
							<button class="btn btn-success" type="button" onclick="save_excellence()"> <i class="fa fa-edit"></i> Save</button>
						</div>
					</div>
				</div>
			</form>
...
<div class="modal modal-default" id="deleterecordid" >
  	<div class="modal-dialog modal-lg">
    	<div class="modal-content">
        <form class="bootbox-form form-horizontal" method="POST" action="/529288ce6f5efcd3a2f57dea8f48fb4131f90c3e/29e9b464daf4fc9339b77667bbe8179a" id="deleteserviceform">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript">
	...
	function clear_form(){
 	...
 	function showedit(id){
		let url='/529288ce6f5efcd3a2f57dea8f48fb4131f90c3e/2d46ce35ca103346bcfaa0c995da6099/'+id;
        $.ajax({
			'url': url,
			'type': 'GET',
			'dataType': 'json',
			'success': function(data){  
                ...
                let current_image='<br><img  src="<?php echo base_url();?>images/cleaningprocess/'+data.image+'" width="150" class="img-text"> ';
	...
	function save_excellence(){
		if(validatedform()){
			$('#excellancyform').submit();
		}
	}
</script>
