...
<div class="modal modal-default" id="adddesignationid">
  	<div class="modal-dialog modal-lg">
    	<div class="modal-content">
            <form class="bootbox-form form-horizontal" enctype="multipart/form-data" method="POST" action="/529288ce6f5efcd3a2f57dea8f48fb4131f90c3e/f82f14bcb55ca6da880d182cee0c9123" id="servicesform">
...
<div class="modal modal-default" id="deleterecordid" >
  	<div class="modal-dialog modal-lg">
    	<div class="modal-content">
        <form class="bootbox-form form-horizontal" method="POST" action="/529288ce6f5efcd3a2f57dea8f48fb4131f90c3e/2346265cc0cdd0977eeacc481987e123" id="deleteserviceform">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript">
	...
	function clear_form(){
 	...
 	function showedit(id){
		let url='/529288ce6f5efcd3a2f57dea8f48fb4131f90c3e/998dcb8c3a48509268b92532f247b123/'+id;
        $.ajax({
			'url': url,
			'type': 'GET',
			'dataType': 'json',
